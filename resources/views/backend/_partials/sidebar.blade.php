...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="kategori_buku.html" class="nav-item nav-link {{ (request()->is('kategori_buku*')) ? 'active' : '' }}"><i class="fa fa-book-open me-2"></i>Kategori Buku</a>
            ...
            <a href="{{route('backend-index-user')}}" class="nav-item nav-link {{ (request()->is('peminjam*')) ? 'active' : '' }}"><i class="fa fa-user me-2"></i>Peminjam</a>
